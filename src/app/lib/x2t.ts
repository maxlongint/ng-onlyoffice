...
// ... existing code ...
// Deleted:export const c_oAscFileType2 = Object.fromEntries(
// Deleted:    Object.entries(oAscFileType).map(([key, value]) => [value, key])
// Deleted:) as Record<number, keyof typeof oAscFileType>;

// 兼容 Object.fromEntries 的实现
const fromEntries = <T extends PropertyKey, U>(entries: Iterable<readonly [T, U]>): Record<T, U> => {
...
export const c_oAscFileType2 = fromEntries(
    Object.entries(oAscFileType).map(([key, value]) => [value as unknown as PropertyKey, key])
